...
const LIVROS_DICIONARIO = {
  "01-parnasodealemtumulo": {
    ...
    ano: 1932,
    descricao:
      "A primeira obra psicografada por Chico Xavier. Reúne poemas extraordinários ditados por grandes poetas falecidos da língua portuguesa, atestando a imortalidade da alma.",
  },
  "02-cartasdeumamorta": {
    ...
    ano: 1935,
    descricao:
      "Coletânea de cartas consoladoras e esclarecedoras da mãe de Chico Xavier, narrando com afeto e delicadeza suas primeiras impressões da vida no plano espiritual.",
  },
  "03-palavras-do-infinito": {
    ...
    ano: 1936,
    descricao:
      "Valiosas páginas de instrução moral e consolação recebidas de variados mentores espirituais, estimulando o autoaperfeiçoamento à luz do Cristo.",
  },
  "04-cronicasdealemturmulo": {
    ...
    ano: 1937,
    descricao:
      "Crônicas tocantes de Humberto de Campos no plano espiritual, analisando as fraquezas humanas e a grandeza das leis divinas com sensibilidade ímpar.",
  },
  "05-emmanuel": {
    titulo: "Emmanuel",
    ...
    ano: 1938,
    descricao:
      "Estudos e dissertações profundas sobre ciência, filosofia, história e religião conduzidas pelo benfeitor espiritual Emmanuel.",
  },
  "06-brasil_coracao_do_mundo_patria_do_evangelho": {
    ...
    ano: 1938,
    descricao:
      "Revelação fascinante sobre a missão espiritual e o destino transcendente do Brasil como polo difusor da mensagem evangélica para a humanidade.",
  },
  "07-lira_imortal": {
    titulo: "Lira Imortal",
    autorEspiritual: "Espíritos Diversos",
    ...
    ano: 1938,
    descricao:
      "Belo relicário poético estruturado por poetas consagrados que prosseguem cantando o amor, a natureza e as sublimes verdades da vida espiritual.",
  },
  "08-acaminhodaluz": {
    ...
    ano: 1939,
    descricao:
      "A extraordinária história da evolução humana sob o olhar compassivo do Cristo Jesus. Um farol que esclarece os fatos históricos sob a ótica espiritual.",
  },
  "09-novasmensagens": {
    ...
    ano: 1940,
    descricao:
      "Mais um conjunto de ensinamentos proveitosos voltados para a renovação íntima e o despertamento espiritual do trabalhador cristão.",
  },
  "10-ha2000anos": {
    titulo: "Há 2000 Anos",
    autorEspiritual: "Emmanuel",
    ...
    ano: 1939,
    descricao:
      "Inesquecível romance histórico narrando a encarnação do senador romano Publius Lentulus na época do Cristo. Uma obra clássica de renúncia, fé e amor.",
  },
  "11-50anosdepois": {
    ...
    ano: 1940,
    descricao:
      "A tocante continuação de 'Há 2000 Anos', retratando a reencarnação do senador Publius Lentulus sob as vestes de Nestório, um humilde escravo cristão.",
  },
  "12-cartasdoevangelho": {
    ...
    ano: 1941,
    descricao:
      "Versos simples, cativantes e de profunda beleza espiritual, comentando lições eternas do Evangelho para o nosso aprimoramento moral diário.",
  },
  "13-oconsolador": {
    titulo: "O Consolador",
    autorEspiritual: "Emmanuel",
    ...
    ano: 1941,
    descricao:
      "Uma obra indispensável que oferece esclarecimento seguro para a mente e consolo doce para o coração em 411 respostas profundas formuladas por Emmanuel.",
  },
  "14-boanova": {
    titulo: "Boa Nova",
    autorEspiritual: "Humberto de Campos",
    ...
    ano: 1941,
    descricao:
      "Belíssimas narrativas que reconstituem episódios marcantes da vida e pregação de Jesus com Seus apóstolos, ressaltando o espírito amoroso do Evangelho.",
  },
  "15-pauloeestevao": {
    ...
    ano: 1941,
    descricao:
      "Soberbo painel histórico-espiritual que reconstitui a saga gloriosa do Apóstolo Paulo de Tarso sob a inspiradora e constante influência do mártir Estêvão.",
  },
  "16-renuncia": {
    titulo: "Renúncia",
    autorEspiritual: "Emmanuel",
    ...
    ano: 1944,
    descricao:
      "Sublime história de amor, sacrifício e profunda renúncia espiritual, retratando a encarnação de Alcíone para salvar e guiar seu companheiro de outrora.",
  },
  "17-reportagensdealemtumulo": {
    ...
    ano: 1943,
    descricao:
      "Mensagens instigantes e reportagens do plano espiritual que descortinam a ilusão da matéria e a verdade da existência imperecível da alma.",
  },
  "18-cartilhadanatureza": {
    ...
    ano: 1944,
    descricao:
      "Páginas repletas de doçura e sabedoria infantil e lúdica, apresentando a simplicidade das trovas poéticas para instruir as almas no caminho do bem.",
  },
  "19-nossolar": {
    titulo: "Nosso Lar",
    ...
    ano: 1944,
    descricao:
      "A célebre obra que descortina a jornada de André Luiz na pátria espiritual, narrando com riqueza de detalhes a vida e as tarefas na colônia de regeneração Nosso Lar.",
  },
  "20-osmensageiros": {
    ...
    ano: 1944,
    descricao:
      "André Luiz revela o trabalho incessante de socorro espiritual e a preparação dos espíritos mensageiros antes de retornar à crosta física.",
  },
  "21-missionariosdaluz": {
    ...
    ano: 1945,
    descricao:
      "Um estudo fascinante sobre a mediunidade, o planejamento de reencarnações e o amparo espiritual dispensado nas transições do plano físico para o extrafísico.",
  },
  "22-coletaneasdoalem": {
    ...
    ano: 1945,
    descricao:
      "Diversos ensinamentos fraternos focados no consolo moral, no reerguimento da alma e na compreensão do sofrimento à luz da imortalidade.",
  },
  "23-lazaroredivivo": {
    ...
    ano: 1945,
    descricao:
      "Humor fino, observação profunda e agudeza espiritual por Humberto de Campos (Irmão X), despertando-nos para a vivência integral da caridade cristã.",
  },
  "24-obreirosdavidaeterna": {
    ...
    ano: 1946,
    descricao:
      "Sublimes ensinamentos e descrições do plano espiritual sobre a transição do corpo de carne para a pátria espiritual de devotados seareiros.",
  },
  "25-ocaminhooculto": {
    ...
    ano: 1947,
    descricao:
      "Preciosas lições morais comentadas por Emmanuel, nos direcionando no caminho silencioso da fé viva e do crescimento individual perante Deus.",
  },
  "237-humorismo-no-alem-espiritos-diversos-chico-xavier-ano-1984": {
    ...
    ano: 1984,
    descricao:
      "Crônicas e causos leves e cheios de bom humor psicografados por Chico Xavier. Demonstra que a alegria nobre e o sorriso sincero sobrevivem à morte.",
  },
  "248-fe-espiritos-diversos-chico-xavier-carlos-a.bacelli": {
    ...
    ano: 1984,
    descricao:
      "Uma profunda exaltação à fé viva e raciocinada, incentivando a confiança absoluta no Criador diante das tormentas humanas.",
  },
  "354-mentores_e_seareiros": {
    ...
    ano: 1990,
    descricao:
      "Coletânea de reflexões e instruções práticas ditadas por mentores espirituais para guiar e inspirar os trabalhadores do movimento espírita.",
  },
  "36-caminhoverdadeevida": {
    ...
    ano: 1948,
    descricao:
      "Primeiro livro da monumental coleção de comentários a versículos do Novo Testamento, convocando-nos a vivenciar o Cristianismo Redivivo.",
  },
  "39-pao_nosso": {
    titulo: "Pão Nosso",
    autorEspiritual: "Emmanuel",
    ...
    ano: 1950,
    descricao:
      "Segundo volume de comentários ao Evangelho, oferecendo alimento espiritual nutritivo e indispensável para a caminhada evolutiva diária.",
  },
  "412-amor_e_verdade": {
    ...
    ano: 1999,
    descricao:
      "Mensagens inspiradoras de Emmanuel e outros espíritos benfeitores, destacando o amor incondicional e a busca pela verdade interna.",
  },
  "44-vinha_de_luz": {
    titulo: "Vinha de Luz",
    autorEspiritual: "Emmanuel",
    ...
    ano: 1951,
    descricao:
      "Terceiro livro de comentários de Emmanuel. Traz profundas lições baseadas nas epístolas apostólicas para a iluminação da conduta cristã.",
  },
  "55-fonte_viva": {
    titulo: "Fonte Viva",
    autorEspiritual: "Emmanuel",
    ...
    ano: 1953,
    descricao:
      "Quarto livro da coleção de comentários evangélicos. Lições luminosas que acalmam a alma e jorram sabedoria crística no coração do leitor.",
  },
  "83-palavrasdevidaeterna": {
    ...
    ano: 1962,
    descricao:
      "Quinto livro de comentários de Emmanuel, guiando o leitor a encontrar no Evangelho do Cristo a bússola perfeita para as decisões da alma.",
  },
  "93-eavidacontinua": {
    ...
    ano: 1968,
    descricao:
      "Fechando a clássica coleção de André Luiz, esta obra narra de forma eletrizante os reencontros e as lutas evolutivas de almas afins na vida além-túmulo.",
  },
};
...
function parseFallbackMetadata(filename) {
  ...
  let titulo = cleanedName
    ...
    .map((word) => {
      if (
        word.length <= 2 &&
        !["a", "o", "no", "do", "da", "de", "e", "em", "um", "uma"].includes(word.toLowerCase())
      ) {
...
function sync() {
  ...
  for (const file of files) {
    ...
    const normalizedNewAuthor = (meta.autorEspiritual || "")
      .toLowerCase()
      .replace(/[^a-z0-9]/g, "");

    const isDuplicate = booksList.find((b) => {
      const normalizedExistingTitle = b.titulo.toLowerCase().replace(/[^a-z0-9]/g, "");
      const normalizedExistingAuthor = (b.autorEspiritual || "")
        .toLowerCase()
        .replace(/[^a-z0-9]/g, "");
      return (
        normalizedExistingTitle === normalizedNewTitle &&
        normalizedExistingAuthor === normalizedNewAuthor
      );
    });

    if (isDuplicate) {
      console.log(
        `[Duplicado Ignorado] O arquivo "${file}" representa o livro "${meta.titulo}" que já foi catalogado através do arquivo "${isDuplicate.arquivo}".`,
      );
      continue;
    }
