...
const FAQ: FaqItem[] = [
  ...
  },
  {
    ...
    resposta:
      "O site avisa por e-mail o que acontece com o que é seu, e só isso — não há propaganda, e o seu endereço não é passado a ninguém. Chegam por padrão: alguém se interessou por um item que você anunciou no bazar, alguém pediu vaga na sua carona, alguém se ofereceu para um pedido seu no voluntariado, um voluntário assumiu a sua entrega, e a resposta de quem você procurou (reserva aceita ou recusada, vaga confirmada). Dois avisos nascem desligados, porque falam da casa e não de você: os pedidos de acolhimento abertos no fórum e os pedidos de ajuda que combinam com as habilidades que você cadastrou no voluntariado. Há ainda o aviso dos aniversariantes do dia, enviado pela manhã apenas nos dias em que alguém faz aniversário — ele chega para quem é da direção da casa, e qualquer pessoa pode ligá-lo ou desligá-lo. Passo a passo para escolher: 1) No menu superior, abra 'Ajuda' e clique em 'Avisos por e-mail'. 2) Marque ou desmarque cada linha. 3) Clique em 'Salvar preferências'. O mesmo endereço aparece no rodapé de todo e-mail enviado pelo site, para você desligar direto de lá. Um aviso nunca é enviado duas vezes, e só chega a quem confirmou o próprio e-mail no cadastro.",
  },
  {
