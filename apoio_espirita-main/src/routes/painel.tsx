...
const roadmap: Item[] = [
  ...
  { status: "feito", titulo: "Menu de Tesouraria visível apenas para Presidente e Vice-presidente", descricao: "A opção de Tesouraria só aparece no menu para quem tem cargo de Presidente ou Vice-presidente" },
  ...
  { status: "planejado", titulo: "Agenda completa por casa espírita — compromissos e reuniões", descricao: "O Presidente e os autorizados criam compromissos na agenda da casa. Ao criar, definem se o evento é aberto a todos ou apenas para participantes convidados. As pessoas convidadas recebem um aviso por e-mail e, se possível, por WhatsApp. Cada membro vê a agenda pública da casa e os compromissos em que foi incluído. Reuniões abertas ou fechadas com confirmação de presença, livro de presença digital e geração automática de ata ao final." },
  ...
  { status: "planejado", titulo: "Tesouraria simplificada — controle de entradas e saídas", descricao: "Controle financeiro simples e acessível, pensado para quem não tem familiaridade com tecnologia · Registro de doações, despesas e receitas · Acesso controlado pelo Presidente" },
