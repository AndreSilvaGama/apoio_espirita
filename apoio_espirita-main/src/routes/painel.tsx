...
const roadmap: Item[] = [
  ...
  { status: "planejado", titulo: "Expansão dos cargos cadastráveis no perfil", descricao: "21 cargos no total: Presidente · Vice-presidente · Coordenador · Diretoria · Dirigente · Dirigente de reunião mediúnica · Tesoureiro · Atendente fraterno · Médium · Passista · Evangelizador · Expositor · Facilitador · Sócio · Associado · Assistido · Participante de estudo · Colaborador · Trabalhador · Tarefeiro · Visitante" },
