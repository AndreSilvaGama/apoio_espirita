  ...
  Virtudes: [
    {
      ...
      significado:
        "O amor resume toda a doutrina de Jesus e é a chave para a harmonia e felicidade real do espírito.",
    },
    {
      palavra: "CARIDADE",
      ...
      significado:
        "Allan Kardec sintetizou o caminho espiritual no famoso lema: 'Fora da caridade não há salvação'.",
    },
    {
      palavra: "PERDAO",
      ...
      significado:
        "Perdoar nos liberta das amarras do passado e atrai a misericórdia divina para nossas próprias imperfeições.",
    },
    {
      palavra: "HUMILDADE",
      ...
      significado:
        "A humildade afasta o orgulho, permitindo que a luz espiritual e a sabedoria penetrem em nosso coração.",
    },
    {
      palavra: "PACIENCIA",
      ...
      significado:
        "A paciência é o amor que sabe esperar. Ela evita reações impulsivas e protege nossa paz interior.",
    },
    {
      ...
      significado:
        "A benevolência para com todos faz parte da definição de verdadeira caridade ensinada pelos espíritos.",
    },
    {
      palavra: "INDULGENCIA",
      ...
      significado:
        "A indulgência nos ensina a não julgar nossos irmãos, lembrando que também carregamos fragilidades.",
    },
    {
      palavra: "ESPERANCA",
      ...
      significado:
        "A esperança renova nossas forças nas horas de dor, assegurando-nos que a tempestade sempre passa.",
    },
    {
      ...
      significado:
        "Como irmãos em Cristo, a solidariedade nos convoca a cooperar uns com os outros na construção do bem coletivo.",
    },
  ],
  Livros: [
    {
      ...
      significado:
        "Contém os princípios da Doutrina Espírita sobre a imortalidade da alma, a natureza dos espíritos e as leis morais.",
    },
    {
      palavra: "MEDIUNS",
      ...
      significado:
        "Trata do desenvolvimento da mediunidade, dos tipos de manifestações e da obsessão, orientando a prática fraterna.",
    },
    {
      palavra: "EVANGELHO",
      ...
      significado:
        "Explica as máximas do Cristo de forma clara e consoladora, servindo de roteiro prático para a reforma íntima.",
    },
    {
      palavra: "CEU",
      ...
      significado:
        "Demonstra que a felicidade ou sofrimento do espírito no além-túmulo decorre de suas próprias escolhas e atitudes.",
    },
    {
      palavra: "GENESE",
      ...
      significado:
        "Estuda a criação do mundo, os milagres sob a ótica científica e espiritual, e as transições planetárias.",
    },
    {
      palavra: "NOSSO LAR",
      ...
      significado:
        "Psicografado por Chico Xavier, descreve a organização e o serviço de auxílio em uma colônia espiritual de transição.",
    },
  ],
  Personagens: [
    {
      ...
      significado:
        "Hippolyte Léon Denizard Rivail, sob o pseudônimo de Allan Kardec, organizou as bases científicas e morais do Espiritismo.",
    },
    {
      palavra: "CHICO",
      ...
      significado:
        "Francisco Cândido Xavier psicografou mais de 450 livros e doou todos os direitos autorais para obras de caridade.",
    },
    {
      palavra: "EMMANUEL",
      ...
      significado:
        "Orientou Chico com sabedoria, autor de romances históricos clássicos e de belíssimas mensagens de conduta cristã.",
    },
    {
      palavra: "ANDRE",
      ...
      significado:
        "Trouxe revelações fundamentais sobre as atividades, habitações e leis que regem os espíritos no plano espiritual.",
    },
    {
      palavra: "BEZERRA",
      ...
      significado:
        "Político, médico e intelectual brasileiro que dedicou sua existência ao amparo dos necessitados e difusão do Espiritismo.",
    },
  ],
};
